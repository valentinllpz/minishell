...
/*   Updated: 2021/06/07 14:12:25 by ade-garr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	while (tmp != NULL)
// 	{
// 		if (ft_strncmp((char *)tmp->content, shell->exec[i],
// 		ft_strlen_safe(shell->exec[i])) == 0)
// 		{
// 			if (((char *)tmp->content)[ft_strlen_safe(shell->exec[i])
// 			== '=' || ((char *)tmp->content)[ft_strlen_safe(shell->exec[i])]
// 			== '\0')
// 			{
// 				tmp_bis = tmp;
// 				free(tmp->content);
